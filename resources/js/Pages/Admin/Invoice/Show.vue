...
// Delete invoice
const deleteInvoice = () => {
    if (confirm(`Yakin ingin menghapus invoice ${props.invoice.invoice_number}? Tindakan ini tidak dapat dibatalkan.`)) {
                ...
                <div class="bg-white rounded-xl shadow-sm p-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <button
                            ...
                            @click="deleteInvoice"
                            class="w-full py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 text-sm flex items-center justify-center gap-2"
                        >
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
