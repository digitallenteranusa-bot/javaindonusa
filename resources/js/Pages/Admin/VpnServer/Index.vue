    ...
    <AdminLayout>
        <template #header>
            <div class="flex items-center justify-between">
                <h1 class="text-2xl font-bold text-gray-900">VPN Server Management</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            ...
            <div class="bg-white rounded-xl shadow-sm p-4">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-sm text-gray-500">OpenVPN</p>
                        <p class="text-2xl font-bold">{{ stats.openvpn_clients }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm p-4">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-sm text-gray-500">WireGuard</p>
                        <p class="text-2xl font-bold">{{ stats.wireguard_clients }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm p-4">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold">{{ stats.enabled_clients }}</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white rounded-xl shadow-sm p-4">
                <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center gap-2">
                        ...
                        ></span>
                        <h3 class="font-semibold">OpenVPN Server</h3>
                    </div>
                    <div class="flex gap-2">
                        <button
                ...
                <div class="space-y-2 text-sm">
                    <div class="flex justify-between">
                        ...
                        <span :class="openVpnStatus.openvpn_installed ? 'text-green-600' : 'text-red-600'">
                            {{ openVpnStatus.openvpn_installed ? 'Yes' : 'No' }}
                        </span>
                    </div>
                    <div class="flex justify-between">
                    ...
                    <div class="flex justify-between">
                        <span class="text-gray-500">Server Cert</span>
                        <span :class="openVpnStatus.server_cert_exists ? 'text-green-600' : 'text-red-600'">
                            {{ openVpnStatus.server_cert_exists ? 'Yes' : 'No' }}
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm p-4">
                <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center gap-2">
                        ...
                        ></span>
                        <h3 class="font-semibold">WireGuard Server</h3>
                    </div>
                    <div class="flex gap-2">
                        <button
                ...
                <div class="space-y-2 text-sm">
                    <div class="flex justify-between">
                        ...
                        <span :class="wireGuardStatus.wireguard_installed ? 'text-green-600' : 'text-red-600'">
                            {{ wireGuardStatus.wireguard_installed ? 'Yes' : 'No' }}
                        </span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-gray-500">Server Keys</span>
                        <span :class="wireGuardStatus.server_keys_exist ? 'text-green-600' : 'text-red-600'">
                            {{ wireGuardStatus.server_keys_exist ? 'Yes' : 'No' }}
                        </span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-gray-500">Interface</span>
                        <span :class="wireGuardStatus.interface_up ? 'text-green-600' : 'text-gray-500'">
                            {{ wireGuardStatus.interface_up ? 'Up (wg0)' : 'Down' }}
                        </span>
                    </div>
                </div>
            </div>
