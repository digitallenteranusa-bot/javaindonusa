...
const getDistanceToCustomer = (customer) => {
    if (!currentLocation.value || !customer.latitude || !customer.longitude) return null
...
// Navigate to customer using Google Maps with directions
                    ...
                    <div class="px-4 pb-4">
                        <div class="flex gap-2">
                            <button
                                ...
                                class="flex items-center justify-center gap-1 px-3 py-2 bg-orange-500 text-white rounded-lg text-sm"
                            ...
                            <button
                                ...
                                class="flex items-center justify-center gap-1 px-3 py-2 bg-gray-100 text-gray-700 rounded-lg text-sm"
                            >
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
