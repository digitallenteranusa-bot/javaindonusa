            ...
            >
                ...
                <div class="px-4 py-3 bg-gray-50 border-t flex gap-2">
                    ...
                    <button
                        ...
                        :disabled="rt.customers_count > 0 || rt.areas_count > 0"
                        :class="{ 'opacity-50 cursor-not-allowed': rt.customers_count > 0 || rt.areas_count > 0 }"
                        :title="rt.customers_count > 0 || rt.areas_count > 0 ? 'Router masih memiliki pelanggan/area' : 'Hapus router'"
                    >
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
