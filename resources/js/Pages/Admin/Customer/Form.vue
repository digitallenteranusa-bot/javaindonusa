...
const openMapPicker = async () => {
    ...
    map = L.map(mapContainer.value, { maxZoom: 27 }).setView([defaultLat, defaultLng], 17)
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                        >
                        <p class="text-xs text-gray-500 mt-1">Kosongkan untuk pelanggan lama. Invoice akan di-generate mulai bulan ini.</p>
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-sm p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <p class="text-xs text-gray-500 mt-1 ml-8">Jika dicentang, BHP USO 2% akan ditambahkan ke invoice setelah diskon</p>
                    </div>
                </div>
            </div>
